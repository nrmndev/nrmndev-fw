...
import { default as propToClass } from "./asClassName";
...
export const propStyleHandler = (props: PropStyleHanlderProps) => {
  ...
  typeof paddingStyles === "string"
    ? styleAsClassNames.push(paddingStyles)
    : (styleAsInlineStyle = { ...styleAsInlineStyle, ...paddingStyles });

  console.log(styleAsClassNames);
  ...
  className.push(
    propToClass.text({ textTransform, textDecoration, textAlign })
  );
